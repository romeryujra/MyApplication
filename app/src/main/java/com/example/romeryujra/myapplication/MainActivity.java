package com.example.romeryujra.myapplication;
...
//cambio de actividad AudioVisual
        ...
        btnmenu2.setOnClickListener(new View.OnClickListener() {
                                        public void onClick(View view) {
                                            ...
                                            toast1.show();
                                            move=new Intent(MainActivity.this, AudioVisual.class);
                                            startActivity(move);
                                        }
                                    }
        );
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            iv.setImageDrawable(getResources().getDrawable(R.drawable.encendido));
            ...
            case R.id.btnscroll2:
                ...
                tv_title.setTextSize(15);
                iv = new ImageView(this);
                iv.setImageDrawable(getResources().getDrawable(R.drawable.bateri));
            ...
            case R.id.btnscroll3:
                ...
                tv_title.setTextSize(15);
                iv = new ImageView(this);
                iv.setImageDrawable(getResources().getDrawable(R.drawable.fecha));
                iv.setScaleType(ImageView.ScaleType.FIT_CENTER);
                tv = new TextView(this);
                //tv.setText("Some new text");
            ...
            case R.id.btnscroll4:
                ...
                tv_title.setTextSize(15);
                iv = new ImageView(this);
                iv.setImageDrawable(getResources().getDrawable(R.drawable.actualizacion_bd));
                iv.setScaleType(ImageView.ScaleType.FIT_CENTER);
                tv = new TextView(this);
                //tv.setText("Some new text");
